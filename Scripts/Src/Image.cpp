...
Image::Image(Device *device, uint32_t width, uint32_t height, VkFormat format, VkImageTiling tiling, VkImageUsageFlags usage, VkMemoryPropertyFlags properties, VkImageAspectFlags aspectFlags, VkImageType type)
{
	createImage(device, width, height, format, tiling, usage, properties,type);
	createImageView(device, format, aspectFlags);
}
...
void Image::createImage(Device *device,uint32_t width, uint32_t height, VkFormat format, VkImageTiling tiling, VkImageUsageFlags usage, VkMemoryPropertyFlags properties, VkImageType type ) {
...
void Image::transitionImageLayout(Device *device, CommandPool *commandPool, VkFormat format, VkImageLayout oldLayout, VkImageLayout newLayout) {
...
void Image::copyBufferToImage(Device *device, CommandPool *commandPool,Buffer *buffer, uint32_t width, uint32_t height) {
	VkCommandBuffer commandBuffer = commandPool->beginSingleTimeCommands(device);
